...
export const AudioControls = ({ isRecording, isLoading, onToggleRecording, disabled = false, }) => {
    return (_jsxs("button", { onClick: onToggleRecording, disabled: isLoading || disabled, className: `

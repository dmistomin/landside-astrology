...
export const useAudioTranscription = ({ apiKey, } = {}) => {
    ...
    const { connectionState, transcriptSegments, error: transcriptionError, connect: connectTranscription, disconnect: disconnectTranscription, sendAudioData, clearTranscript, } = useDeepGramTranscription({ apiKey });
